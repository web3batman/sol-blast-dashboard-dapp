      ...
      <div className="drop-shadow-[0_0_2px_#F8EF00]">
        <div ref={modalRef} className="bg-[#201F07]">
          <div className="max-w-[600px] shadow-whiteyellow drop-shadow-xl max-md:max-w-[400px] max-sm:max-w-[300px]">
            <h4 className="relative pb-5 pt-3 text-center text-3xl font-bold uppercase leading-9 tracking-[0.08em] text-whiteyellow after:absolute after:bottom-0 after:left-0 after:h-2 after:w-full after:bg-[url('/dividers/rewards-page-right-top-divider.svg')] after:content-[''] max-2xl:text-2xl max-lg:text-lg max-sm:pb-2 max-sm:text-xl">
            ...
            <div className="rounded-md bg-[#151910] p-3 backdrop-blur-[2px] max-sm:py-0">
              ...
              <Image
                ...
                width={350}
                height={500}
                className="m-auto mt-4 max-sm:mt-1 max-sm:h-[200px] max-sm:w-[250px]"
              />
            </div>
          </div>
        </div>
